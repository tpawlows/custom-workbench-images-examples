...
The following custom workbench images are available in this collection:
...
Follow these steps to install and use the custom workbench images in your Red Hat OpenShift AI environment.
